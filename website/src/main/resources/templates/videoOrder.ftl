		...
		<script type="text/javascript">
			$(function(){
				$(".orderBtn").click(function () {
					...
					jQuery.post("/apply",params,function(result){
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9">
					...
					<#if success??>
						<p class="bg-info">您已经完成了视频认证</p>
					<#elseif videoAuth??>
						<p class="bg-info">
							恭喜您，预约成功：客服：${videoAuth.auditor.username}
							,预约时间：${videoAuth.orderBeginDate?string('yyyy-MM-dd HH:mm')}
							-${videoAuth.orderEndDate?string('yyyy-MM-dd  HH:mm')}
						</p>
					<#else>
