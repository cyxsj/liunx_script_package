...
<html>
	...
	<body>
		...
		<div class="row h4 account-info">
            ...
            <div class="col-sm-2">
                总投资人数：<span class="text-primary">${totalUser}</span>
            </div>

            <div class="col-sm-2">
                总借款人数：<span class="text-primary">${totalCreateUser}</span>
            </div>

            <div class="col-sm-3">
                总借款金额：<span class="text-primary">${totalBidRequestAmount?string('#0.00')} 元</span>
            </div>

            <div class="col-sm-3">
                产生总收益：<span class="text-primary">${totalRewardAmount?string('#0.00')} 元</span>
            </div>

            <div class="col-sm-2">
                总待收本息：<span class="text-primary">${totalUnReceiveInterest?string('#0.00')} 元</span>
            </div>
        </div>
